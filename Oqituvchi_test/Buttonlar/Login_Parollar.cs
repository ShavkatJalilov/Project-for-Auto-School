...
{
    public partial class Login_Parollar : Form
    {
        public Login_Parollar()
        {
            InitializeComponent();
        }
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            int i = 0;
            sql.Open();
            var cmd = new SqlCommand($"select Logins, Parols from Login where Logins='{guna2TextBox1.Text}' and Parols='{guna2TextBox2.Text}'", sql);
                ...
                if (guna2TextBox3.Text.Length > 4 && guna2TextBox5.Text.Length > 4 && guna2TextBox4.Text.Length > 4)
                {
                    if (guna2TextBox3.Text.Equals(guna2TextBox5.Text))
                    {
                        ...
                        xato5.Visible = false;                       
                            int i2 = 0;
                            sql.Open();
                            var cmd2 = new SqlCommand($"select Logins, Parols from Login where Logins='{guna2TextBox4.Text}' and Parols='{guna2TextBox3.Text}'", sql);
                            ...
                            {
                                sql.Open();
                                var cmd1 = new SqlCommand("insert into [Login](Logins,Parols)values(@Logins,@Parols)", sql);
        ...
        private void Login_Parollar_Load(object sender, EventArgs e)
        {
